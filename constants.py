...
# SMTP mail address
SMTP_MAIL = "akshaydatir123@gmail.com"  # (str)

# SMTP mail password
SMTP_PASSWORD = "ddov sjqg bdle lfrq"  # (str)
...
DEFAULT_ADMIN_EMAIL = "admin123#"  # (str)
...
# reCAPTCHA site key
RECAPTCHA_SITE_KEY = "6Ldf8a4qAAAAAPrCCKdKT87Oup3EHyQ0OrnOuhQ_"  # (str)

# reCAPTCHA secret key
RECAPTCHA_SECRET_KEY = "6Ldf8a4qAAAAAO-neUOOLTtD7Kbe9AIlZc6CsZXW"  # (str)
